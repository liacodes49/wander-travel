...
const BOT_TIPS = [
  "Visit popular spots before 8am — crowds haven't arrived yet! ☀️",
  ...
  "Download offline maps before leaving wifi range. Lifesaver! 🗺️",
  ...
  return (
    <div className="wanderbot" onClick={handleToggle}>
      ...
      <div className={`bot-popup ${isOpen ? 'show' : ''}`}>
        <div className="bot-header">WanderBot 🌍</div>
